...
(function($) {
	...
	$.fn.timepicki = function(options) {
		...
		return this.each(function() {
            ...
            // prev, next 클래스를 timepicki-prev, timepicki-next로 수정 (20.02.20)
			var top_arrow_button = (settings.increase_direction === 'down') ?
				"<div class='timepicki-prev action-prev'></div>" :
				"<div class='timepicki-prev action-next'></div>";
			var bottom_arrow_button = (settings.increase_direction === 'down') ?
				"<div class='timepicki-next action-next'></div>" :
				"<div class='timepicki-next action-prev'></div>";
